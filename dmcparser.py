...
# Calcula la descripcion de los campos de las dimensiones de la matriz. Utiliza los limites
# inferiores y superiores de cada dimension para calcular la cantidad de memoria que
# requiere la matriz. Genera como salida los campos de las dimensiones de la matriz con los valores
# de m1 y k, el espacio que memoria que requiere y su direccion base, y la de la siguiente variable
# Esta funcion se utiliza en la declaracion de variables de 2 dimensiones. 
